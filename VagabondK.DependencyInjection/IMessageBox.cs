...
namespace VagabondK
{
    ...
    public static class IMessageBoxExtensions
    {
        ...
        /// <param name="messageBoxText">메시지</param>
        /// <returns>메시지 상자 결과 반환 태스크</returns>
        public static Task<MessageBoxResult> ShowMessageBox(this IServiceProvider serviceProvider, string messageBoxText) => serviceProvider.ShowMessageBox(messageBoxText, string.Empty);
        ...
        /// <param name="caption">제목</param>
        /// <returns>메시지 상자 결과 반환 태스크</returns>
        public static Task<MessageBoxResult> ShowMessageBox(this IServiceProvider serviceProvider, string messageBoxText, string caption) => serviceProvider.ShowMessageBox(messageBoxText, caption, MessageBoxButton.OK);
        ...
        /// <param name="button">메시지 상자에 표시되는 단추</param>
        /// <returns>메시지 상자 결과 반환 태스크</returns>
        public static Task<MessageBoxResult> ShowMessageBox(this IServiceProvider serviceProvider, string messageBoxText, MessageBoxButton button) => serviceProvider.ShowMessageBox(messageBoxText, string.Empty, button);
        ...
        /// <param name="icon">아이콘</param>
        /// <returns>메시지 상자 결과 반환 태스크</returns>
        public static Task<MessageBoxResult> ShowMessageBox(this IServiceProvider serviceProvider, string messageBoxText, MessageImage icon) => serviceProvider.ShowMessageBox(messageBoxText, string.Empty, MessageBoxButton.OK, icon);
        ...
        /// <param name="button">메시지 상자에 표시되는 단추</param>
        /// <returns>메시지 상자 결과 반환 태스크</returns>
        public static Task<MessageBoxResult> ShowMessageBox(this IServiceProvider serviceProvider, string messageBoxText, string caption, MessageBoxButton button) => serviceProvider.ShowMessageBox(messageBoxText, caption, button, MessageImage.None);
        ...
        /// <param name="icon">아이콘</param>
        /// <returns>메시지 상자 결과 반환 태스크</returns>
        public static Task<MessageBoxResult> ShowMessageBox(this IServiceProvider serviceProvider, string messageBoxText, string caption, MessageBoxButton button, MessageImage icon) => serviceProvider.ShowMessageBox(messageBoxText, caption, button, icon, MessageBoxResult.None);
